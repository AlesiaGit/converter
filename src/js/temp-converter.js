class TempConverter {
	...
	constructor() {
		...
		<div class="switch-wrapper__input-units js-input-units temp-units"></div>\
		<input type="checkbox" class="switch-wrapper__switch js-switch" checked>\
		<div class="switch-wrapper__output-units js-output-units temp-units"></div>\
		</div>\
	...
	fillTempData() {
		document.getElementsByClassName('js-input-data')[0].style.color = '#009688';
		document.getElementsByClassName('js-cell-clear')[0].style.color = '#009688';
		document.getElementsByClassName('js-cell-back')[0].style.backgroundColor = '#009688';
		document.getElementsByClassName('js-switch')[0].style.backgroundColor = '#009688';
		document.getElementsByClassName('js-input-field')[0].style.borderBottomColor = '#009688';
		document.getElementsByClassName('js-input-descr')[0].innerHTML = 'Celcius';
		document.getElementsByClassName('js-output-descr')[0].innerHTML = 'Farenheit';
		document.getElementsByClassName('js-input-units')[0].innerHTML = '°C';
		document.getElementsByClassName('js-output-units')[0].innerHTML = '°F';
	}
	...
	switchData() {
		...
		if (checkedDefault == true) {
			...
			document.getElementsByClassName('js-input-units')[0].innerHTML = '°C';
			document.getElementsByClassName('js-output-units')[0].innerHTML = '°F';
			outputDiv.innerHTML = (parseFloat(inputDiv.value)*9/5 + 32).toFixed(decimal);

		} else {
			document.getElementsByClassName('js-input-descr')[0].innerHTML = 'Farenheit';
			document.getElementsByClassName('js-output-descr')[0].innerHTML = 'Celcius';
			document.getElementsByClassName('js-input-units')[0].innerHTML = '°F';
			document.getElementsByClassName('js-output-units')[0].innerHTML = '°C';
			outputDiv.innerHTML = ((parseInt(inputDiv.value) - 32)*5/9).toFixed(decimal);
		}
	}

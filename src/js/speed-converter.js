class SpeedConverter {
	...
	fillSpeedData() {
		...
		document.getElementsByClassName('js-switch')[0].style.backgroundColor = '#bdbdbd';
		document.getElementsByClassName('js-input-field')[0].style.borderBottomColor = '#bdbdbd';
		document.getElementsByClassName('js-input-descr')[0].innerHTML = 'Miles';
		document.getElementsByClassName('js-output-descr')[0].innerHTML = 'Kilometers';
		document.getElementsByClassName('js-input-units')[0].innerHTML = 'M';
		document.getElementsByClassName('js-output-units')[0].innerHTML = 'KM';
	}
	...
	switchData() {
		...
		if (checkedDefault == true) {
			...
			document.getElementsByClassName('js-input-units')[0].innerHTML = 'M';
			document.getElementsByClassName('js-output-units')[0].innerHTML = 'KM';
			outputDiv.innerHTML = (parseFloat(inputDiv.value)*1.609344).toFixed(decimal);

		} else {
			document.getElementsByClassName('js-input-descr')[0].innerHTML = 'Kilometers';
			document.getElementsByClassName('js-output-descr')[0].innerHTML = 'Miles';
